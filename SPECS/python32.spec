...
# Disable some failing test
Patch158: 00158-disable-tests-in-test_locale.patch
Patch159: 00159-disable-tests-in-test_gdb.patch

# Python shared library should be libpython3.2.so to make
...
# backported to EL5 and EL6 to fix CVE-2012-0876.
# https://rhn.redhat.com/errata/RHSA-2012-0731.html
%{?el5: BuildRequires: expat >= 1.95.8-11.el5_8 }
%{?el6: BuildRequires: expat >= 2.0.1-11.el6_2 }
%{?el7: BuildRequires: expat >= 2.1.0 }
...
# move libpython to 3.2, this will avoid conflicts in the future
...
* Tue Jul 17 2012 BJ Dierkes <wdierkes@rackspace.com> - 3.2.3-8.ius
- Porting from Fedora to IUS python32
- Build against embedded version of expat 
- Comment out --init-eval-commands in Patch156: 00156-gdb-autoload-safepath.patch
